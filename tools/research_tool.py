...
class ResearchTool:
    def search_papers(self, topic: str, offset: int = 0, paper_limit: int = 1, timeout: int = 5) -> str:
...
def main():
    ...
    results = research_tool.search_papers(topic=topic, offset=2, paper_limit=1)
